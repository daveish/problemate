...
shelljs.exec(
  'NODE_ENV=production webpack --config internals/webpack/webpack.prod.babel.js -p --profile --json > stats.json',
...
function callback() {
  ...
  shelljs.exec('webpack-bundle-analyzer stats.json build');
}
